    ...
    async execute(interaction) {
        ...
        if (
            ...
            if (!ticketConfig) {
                ...
                return interaction.reply({
                    content:
                        "This ticket category is not configured correctly.",
                    ephemeral: true
                });
            }
        ...
        if (
            ...
            if (
                ...
                return interaction.reply({
                    content:
                        "You cannot escalate a closed ticket.",
                    ephemeral: true
                });
            }
            ...
            if (
                ...
                return interaction.reply({
                    content:
                        "Only Ticket Support can escalate tickets.",
                    ephemeral: true
                });
            }
            ...
            return interaction.reply({
                ...
                content:
                    `<@&${config.permissions.escalateRoleId}>`,
        ...
        if (
            ...
            try {
                ...
                const transcriptEmbed =
                    new EmbedBuilder()
                        ...
                        .setDescription(
                            `A ticket has been closed by ${interaction.user}.`
                        )
                        .addFields(
            ...
            try {
                ...
                console.log(
                    `Could not DM ticket owner ${ownerId}:`,
                    error.message
                );
            }
